...
if __name__ == "__main__":
    ...
    arm = Kinematics("joint7")
    arm.buildFromMJCF("./control/mujoco/model/franka_emika_panda/panda.xml")
    tf = create_eepose(pos=[0.7, 0.0, 0.3], rot=tf3d.euler.euler2mat(np.pi, 0, 0))
    dof, info = arm.ik(tf)
